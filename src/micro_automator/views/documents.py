...
def extract_text_from_pdf(pdf_stream): # ... (function remains the same)
def extract_text_from_image(image_stream): # ... (function remains the same)

@documents_bp.route('/', methods=['GET'])
def get_all_documents(): # ... (function remains the same)
@documents_bp.route('/<int:doc_id>', methods=['DELETE'])
def delete_document(doc_id): # ... (function remains the same)
